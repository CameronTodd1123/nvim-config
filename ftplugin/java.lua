...
local config = {
  ...
  settings = {
    java = {
      ...
      home = "/Users/camerontodd/Library/Java/JavaVirtualMachines/22-open",
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-1.8",
            path = "/Users/camerontodd/Library/Java/JavaVirtualMachines/adoptopenjdk-8.jdk/Contents/Home",
          },
          {
            name = "JavaSE-11",
            path = "/Users/camerontodd/Library/Java/JavaVirtualMachines/corretto-11.0.10/Contents/Home",
          },
          {
            name = "JavaSE-17",
            path = "/Users/camerontodd/Library/Java/JavaVirtualMachines/corretto-17.0.7/Contents/Home",
          },
        },
      },
      maven = {
